...
{ //  category                         name                          actor (function)             okSafeMode
  //  -------------------------------- ----------------------------- ---------------------------- ----------
    { "omni layer (raw transactions)", "omni_decodetransaction",     &omni_decodetransaction,     {} },
    { "omni layer (raw transactions)", "omni_createrawtx_opreturn",  &omni_createrawtx_opreturn,  {} },
    { "omni layer (raw transactions)", "omni_createrawtx_multisig",  &omni_createrawtx_multisig,  {} },
    { "omni layer (raw transactions)", "omni_createrawtx_input",     &omni_createrawtx_input,     {} },
    { "omni layer (raw transactions)", "omni_createrawtx_reference", &omni_createrawtx_reference, {} },
    { "omni layer (raw transactions)", "omni_createrawtx_change",    &omni_createrawtx_change,    {} },
};
