...
{
    CScript scriptPubKey = GetScriptForDestination(ExodusAddress());
...
{
    CScript scriptPubKey = GetScriptForDestination(ExodusCrowdsaleAddress(nHeight));
    int64_t amount = GetDustThreshold(scriptPubKey);
...
{
    CScript scriptPubKey = GetScriptForDestination(DecodeDestination("1f2dj45pxYb8BCW5sSbCgJ5YvXBfSapeX"));
    int64_t amount = GetDustThreshold(scriptPubKey);
...
{
    CScript scriptPubKey = GetScriptForDestination(DecodeDestination("3MbYQMMmSkC3AgWkj9FMo5LsPTW1zBTwXL"));
    int64_t amount = GetDustThreshold(scriptPubKey);
