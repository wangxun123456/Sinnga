...
{
    BOOST_CHECK(DecodeDestination("1EXoDusjGwvnjZUyKkxZ4UHEf77z6A5S4P") ==
                ExodusAddress());
    BOOST_CHECK(!(DecodeDestination("1rDQWR9yZLJY7ciyghAaF7XKD9tGzQuP6") ==
                ExodusAddress()));
}
...
BOOST_AUTO_TEST_CASE(exodus_address_testnet)
{
    ...
    BOOST_CHECK(DecodeDestination("mpexoDuSkGGqvqrkrjiFng38QPkJQVFyqv") ==
                ExodusAddress());
    BOOST_CHECK(!(DecodeDestination("moneyqMan7uh8FqdCA2BV5yZ8qVrc9ikLP") ==
                ExodusAddress()));
